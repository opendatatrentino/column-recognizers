...
public final class SwebUrlMapper {
    ...
    private static Logger LOG = LoggerFactory.getLogger(SwebUrlMapper.class);

    private static final SwebUrlMapper INSTANCE = new SwebUrlMapper();
    ...
    private SwebUrlMapper() {
        this.base = "http://localhost";
    }

    private SwebUrlMapper(String base) {
        this();
        checkNotNull(base);
     ...
     * @throws IllegalArgumentException on unparseable URL
     */
    public long etypeUrlToConceptId(String url) {
     ...
     */
    public static SwebUrlMapper of() {
        return INSTANCE;
    }
     ...
     */
    public static SwebUrlMapper of(String baseUrl) {
        return new SwebUrlMapper(baseUrl);
    }
}
